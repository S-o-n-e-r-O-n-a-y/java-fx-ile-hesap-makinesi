...
public class Calculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbtnBS.setBackground(new java.awt.Color(255, 0, 0));
        ...
        jbtndigit7.setBackground(new java.awt.Color(0, 153, 0));
        jbtndigit7.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jbtndigit7.setForeground(new java.awt.Color(102, 255, 102));
        ...
        jbtndigit4.setBackground(new java.awt.Color(255, 255, 51));
        jbtndigit4.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jbtndigit4.setForeground(new java.awt.Color(153, 153, 153));
        ...
        jbtndigit1.setBackground(new java.awt.Color(0, 0, 255));
        jbtndigit1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jbtndigit1.setForeground(new java.awt.Color(255, 255, 51));
        ...
        jbtndigit0.setBackground(new java.awt.Color(153, 51, 255));
        jbtndigit0.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jbtndigit0.setForeground(new java.awt.Color(255, 204, 204));
        ...
        jbtnCE.setBackground(new java.awt.Color(153, 0, 153));
        jbtnCE.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jbtnCE.setForeground(new java.awt.Color(255, 255, 51));
        jbtnCE.setText("CE");
        ...
        jbtnDot.setForeground(new java.awt.Color(255, 204, 0));
        jbtnDot.setText(".");
        ...
        jbtndigit2.setBackground(java.awt.SystemColor.desktop);
        jbtndigit2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jbtndigit2.setForeground(new java.awt.Color(204, 204, 204));
        ...
        jbtndigit5.setBackground(new java.awt.Color(255, 204, 51));
        ...
        jbtndigit8.setBackground(new java.awt.Color(0, 153, 51));
        jbtndigit8.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jbtndigit8.setForeground(new java.awt.Color(255, 204, 0));
        ...
        jbtnImpact.setBackground(new java.awt.Color(255, 153, 153));
        jbtnImpact.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jbtnImpact.setForeground(new java.awt.Color(255, 204, 204));
        jbtnImpact.setText("*");
        ...
        jbtndigit3.setForeground(new java.awt.Color(255, 0, 204));
        ...
        jbtnDivide.setBackground(new java.awt.Color(204, 204, 255));
        jbtnDivide.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jbtnDivide.setForeground(new java.awt.Color(51, 255, 0));
        jbtnDivide.setText("/");
        ...
        jbtnMinus.setBackground(new java.awt.Color(255, 102, 51));
        jbtnMinus.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jbtnMinus.setForeground(new java.awt.Color(0, 255, 255));
        jbtnMinus.setText("-");
        ...
        jbtndigit6.setForeground(new java.awt.Color(204, 0, 0));
        ...
        jbtndigit9.setForeground(new java.awt.Color(255, 0, 204));
        ...
        jbtnC.setBackground(new java.awt.Color(102, 0, 102));
        ...
        jbtnPM.setBackground(new java.awt.Color(51, 0, 153));
        ...
        jbtnPlus.setBackground(new java.awt.Color(0, 102, 255));
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .add(jtxtresult, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 34, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(layout.createSequentialGroup()
